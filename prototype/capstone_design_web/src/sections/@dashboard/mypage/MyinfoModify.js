...
/* const VisuallyHiddenInput = styled('input')`     //fileUpload용 스타일
  clip: rect(0 0 0 0);
  clip-path: inset(50%);
  height: 1px;
  overflow: hidden;
...
/*     const [profile, setProfile] = useState(''); */  // 파일 상태
...
/*     const handleFileSelect = (e) => {  //파일 업로드용
